...
# if not all([url, username, password, ollama_base_url, azure_api_key]):
...
#         azure_api_key = st.text_input("Enter Azure API Key", type="password")
#         st.markdown("Enter the required information.")
#         submit_button = st.form_submit_button("Submit")
#     if submit_button:
#         if not all([url, username, password, ollama_base_url, azure_api_key]):
#             st.write("Enter all required information.")
